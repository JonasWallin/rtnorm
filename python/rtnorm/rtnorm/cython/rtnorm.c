...
static int __pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass___init__(CYTHON_UNUSED struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass_2sample(CYTHON_UNUSED struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *__pyx_v_self, CYTHON_UNUSED PyArrayObject *__pyx_v_a, CYTHON_UNUSED PyArrayObject *__pyx_v_b, CYTHON_UNUSED PyArrayObject *__pyx_v_mu, CYTHON_UNUSED PyArrayObject *__pyx_v_sigma, CYTHON_UNUSED int __pyx_v_n); /* proto */
...
static int __pyx_pw_6rtnorm_6cython_6rtnorm_11rtnormClass_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass___init__(((struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *)__pyx_v_self));
...
static int __pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass___init__(CYTHON_UNUSED struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
/* "rtnorm/cython/rtnorm.pyx":29
 * 	@cython.boundscheck(False)
 * 	@cython.wraparound(False)
 * 	def sample(self, np.ndarray[double, ndim=1] a,             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_6rtnorm_6cython_6rtnorm_11rtnormClass_3sample(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  CYTHON_UNUSED PyArrayObject *__pyx_v_mu = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_a,&__pyx_n_s_b,&__pyx_n_s_mu,&__pyx_n_s_sigma,&__pyx_n_s_n,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("sample", 0, 4, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("sample", 0, 4, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_sigma)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("sample", 0, 4, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (kw_args > 0) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "sample") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    if (values[4]) {
      __pyx_v_n = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 33; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_n = ((int)-1);
    }
  }
  ...
  __Pyx_RaiseArgtupleInvalid("sample", 0, 4, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_mu), __pyx_ptype_5numpy_ndarray, 1, "mu", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_sigma), __pyx_ptype_5numpy_ndarray, 1, "sigma", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass_2sample(((struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *)__pyx_v_self), __pyx_v_a, __pyx_v_b, __pyx_v_mu, __pyx_v_sigma, __pyx_v_n);
...
static PyObject *__pyx_pf_6rtnorm_6cython_6rtnorm_11rtnormClass_2sample(CYTHON_UNUSED struct __pyx_obj_6rtnorm_6cython_6rtnorm_rtnormClass *__pyx_v_self, CYTHON_UNUSED PyArrayObject *__pyx_v_a, CYTHON_UNUSED PyArrayObject *__pyx_v_b, CYTHON_UNUSED PyArrayObject *__pyx_v_mu, CYTHON_UNUSED PyArrayObject *__pyx_v_sigma, CYTHON_UNUSED int __pyx_v_n) {
  ...
  __pyx_pybuffernd_sigma.rcbuffer = &__pyx_pybuffer_sigma;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_a.rcbuffer->pybuffer, (PyObject*)__pyx_v_a, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_b.rcbuffer->pybuffer, (PyObject*)__pyx_v_b, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mu.rcbuffer->pybuffer, (PyObject*)__pyx_v_mu, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_sigma.rcbuffer->pybuffer, (PyObject*)__pyx_v_sigma, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
#endif
{
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_6rtnorm_6cython_6rtnorm_rtnormClass) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_type_6rtnorm_6cython_6rtnorm_rtnormClass.tp_print = 0;
  #if CYTHON_COMPILING_IN_CPYTHON
  {
    PyObject *wrapper = PyObject_GetAttrString((PyObject *)&__pyx_type_6rtnorm_6cython_6rtnorm_rtnormClass, "__init__"); if (unlikely(!wrapper)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  #endif
  if (PyObject_SetAttrString(__pyx_m, "rtnormClass", (PyObject *)&__pyx_type_6rtnorm_6cython_6rtnorm_rtnormClass) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
